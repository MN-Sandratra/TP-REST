...
public class HotelData {
    ...
    public CommandLineRunner initDatabase(ChambreRepository chambreRepository, ReservationRepository reservationRepository){
        Lit litS = new LitSimple(50);
        Lit litD = new LitDouble(85);
        Chambre chambre1 = new Chambre(1, new ArrayList<Lit>() {{
            add(litS);
            add(litD);
        }}, "http://localhost:8081/images/Suite_Panoramique.jpg");

        Lit litD2 = new LitDouble(85);
        Lit litD3 = new LitDouble(85);
        Chambre chambre2 = new Chambre(2, new ArrayList<Lit>() {{
            add(litD2);
            add(litD3);
        }}, "http://localhost:8081/images/psg.jpg");

        Lit litS2 = new LitSimple(50);
        Lit litS3 = new LitSimple(50);
        Lit litS4 = new LitSimple(50);
        Chambre chambre3 = new Chambre(3, new ArrayList<Lit>() {{
            add(litS2);
            add(litS3);
            add(litS4);
        }}, "http://localhost:8081/images/chambre-triple.jpg");

        Client client1 = new Client("Dupont", "Roger", "visa");
        Client client2 = new Client("Durand", "Paul", "mastercard");


        GPS gps1 = new GPS(1, 2, 3);

        Adresse adresse1 = new Adresse("France", "Montpellier", "rue Docteur Roger", 1, "Place de la Comedie", gps1);
        ...
        h = new Hotel("Golden Tulip", 5, adresse1, listChambre1);
